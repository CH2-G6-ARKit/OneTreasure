...
class VolcanoIsland: BaseIsland {
    ...
    init(
        ...
        super.init(id: id, name: name, descriptionText: descriptionText, isUnlocked: isUnlocked, unlocksIslandId: unlocksIslandId, islandType: .volcanoSoundQuest, awardsFragmentOrder: awardsFragmentOrder, islandThemeModelName: islandThemeModelName, islandIcon: islandIcon)
    }
