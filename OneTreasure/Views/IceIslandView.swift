...
struct IceIslandView: View {
    @ObservedObject var viewModel: IceIslandViewModel
    @ObservedObject var gameViewModel: GameViewModel
    
    var body: some View {
        ZStack {
            IceIslandARViewContainer(viewModel: viewModel)
    ...
    struct IceIslandARViewContainer: UIViewRepresentable {
        @ObservedObject var viewModel: IceIslandViewModel
        ...
        class Coordinator: NSObject, ARSessionDelegate {
            var viewModel: IceIslandViewModel
            ...
            init(viewModel: IceIslandViewModel) {
