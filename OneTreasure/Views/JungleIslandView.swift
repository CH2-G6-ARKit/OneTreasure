...
struct JungleIslandView: View {
    @ObservedObject var viewModel: JungleIslandViewModel
    @ObservedObject var gameViewModel: GameViewModel
    
    var body: some View {
        ZStack {
            JungleIslandARViewContainer(viewModel: viewModel)
    ...
    struct JungleIslandARViewContainer: UIViewRepresentable {
        @ObservedObject var viewModel: JungleIslandViewModel
        ...
        class Coordinator: NSObject, ARSessionDelegate {
            var viewModel: JungleIslandViewModel
            ...
            init(viewModel: JungleIslandViewModel) {
